...
permalink: /gamify/InfiniteDomain
---
...
<script type="module">
    ...
    import GameLevelPirateBoss from "{{site.baseurl}}/assets/js/GameEnginev1/assets/js/GameEnginev1/InfiniteScrollLevel.js";
    import { pythonURI, javaURI, fetchOptions } from '{{site.baseurl}}/assets/js/api/config.js';

    const gameLevelClasses = [GameLevelInfniniteDomain];
